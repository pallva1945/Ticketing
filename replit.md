...
*   **Financial & Analytics Features**:
    ...
    *   **VB P&L Google Sheets Integration**: Dedicated `vb_pnl` module for syncing Varese Basketball P&L data. Parses Revenue (Sponsorship, BOps, Gameday, EBP), Cost of Sales (BOps, EBP), and SG&A (Team Ops, Labor, Marketing, Office, Utilities, Professional Services, Financial) with monthly breakdowns. Data feeds dynamically into Revenue Executive Overview, Cost Center (EBP/VB sections), and Verticals P&L.

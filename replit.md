...
-   **PVB Potential Score**: Composite 5-pillar player evaluation system. Weights: Size/APS 35%, Athleticism/CAS 25%, Work Ethic 20%, Talent 10% (placeholder — coming from BigQuery stats), Personality 10%. Work Ethic and Personality normalized from 1-5 stars × 20 = 0-100. When factors are unavailable (e.g., Talent), weight is redistributed proportionally across available factors. Minimum 2 factors required. Same Age Factor as CAS/APS applied. Score displayed in PlayerProfileTab (purple gradient card with breakdown bars), PerformanceAnthroTab comparison table (sortable PVB column), and RosterTable overview. Color coding: ≥100 blue, ≥80 emerald, ≥60 amber, ≥40 orange, <40 red. Info modal explains the PVB Potential Matrix methodology.

  ...
  try {
    ...
    const profiles: VBPlayerProfile[] = validRows.map((row: any) => {
      ...
      return {
        ...
        minLate: parseFloat(getField(row, 'Min_Late', 'min_late', 'string_field_16')) || null,
        strength1: getField(row, 'Strenght_1', 'strenght_1', 'Strength_1', 'strength_1', 'string_field_17') ? String(getField(row, 'Strenght_1', 'strenght_1', 'Strength_1', 'strength_1', 'string_field_17')).trim() : null,
        strength2: getField(row, 'Strenght_2', 'strenght_2', 'Strength_2', 'strength_2', 'string_field_18') ? String(getField(row, 'Strenght_2', 'strenght_2', 'Strength_2', 'strength_2', 'string_field_18')).trim() : null,
        strength3: getField(row, 'Strenght_3', 'strenght_3', 'Strength_3', 'strength_3', 'string_field_19') ? String(getField(row, 'Strenght_3', 'strenght_3', 'Strength_3', 'strength_3', 'string_field_19')).trim() : null,
        weakness1: getField(row, 'Weaknesess_1', 'weaknesess_1', 'Weakness_1', 'weakness_1', 'string_field_20') ? String(getField(row, 'Weaknesess_1', 'weaknesess_1', 'Weakness_1', 'weakness_1', 'string_field_20')).trim() : null,
        weakness2: getField(row, 'Weaknesess_2', 'weaknesess_2', 'Weakness_2', 'weakness_2', 'string_field_21') ? String(getField(row, 'Weaknesess_2', 'weaknesess_2', 'Weakness_2', 'weakness_2', 'string_field_21')).trim() : null,
        weakness3: getField(row, 'Weaknesess_3', 'weaknesess_3', 'Weakness_3', 'weakness_3', 'string_field_22') ? String(getField(row, 'Weaknesess_3', 'weaknesess_3', 'Weakness_3', 'weakness_3', 'string_field_22')).trim() : null,
        poe1: getField(row, 'POE_1', 'poe_1', 'string_field_23') ? String(getField(row, 'POE_1', 'poe_1', 'string_field_23')).trim() : null,
        poe2: getField(row, 'POE_2', 'poe_2', 'string_field_24') ? String(getField(row, 'POE_2', 'poe_2', 'string_field_24')).trim() : null,

...
const ADS_TOTAL = COST_LINES.find(l => l.name === 'Advertising and Publications')!.total;
const ADS_PCT = (ADS_TOTAL / GRAND_TOTAL) * 100;

export const MarketingCostDashboard: React.FC = () => {
  const { t } = useLanguage();

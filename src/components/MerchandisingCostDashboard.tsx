...
import { ShoppingBag, Euro, TrendingUp, AlertTriangle } from 'lucide-react';
...
export const MerchandisingCostDashboard: React.FC<MerchandisingCostDashboardProps> = ({ costLines, period = 'Jul–Dec 2025' }) => {
  const { t } = useLanguage();
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h2 className="text-xl font-bold text-gray-900 dark:text-white">{t('Merchandising')} — {t('Cost Structure')}</h2>
          ...
          <table className="w-full text-xs">
            ...
            <tbody>
              ...
              <tr className="border-t-2 border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-800/30">
                <td className="py-2.5 pr-4 font-bold text-gray-900 dark:text-white">{t('Total Merchandising')}</td>

          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div id="rend-video" className={`max-w-5xl mx-auto mb-16 ${fadeClass('rend-video')}`}>
              <div className="relative rounded-xl overflow-hidden bg-black shadow-2xl" style={{ aspectRatio: '16/9' }}>
                <iframe
                  src={`https://www.youtube.com/embed/${tx.videoId}?modestbranding=1&controls=0&rel=0&loop=1&playlist=${tx.videoId}&autoplay=1&mute=1&showinfo=0&iv_load_policy=3&disablekb=1&fs=0&cc_load_policy=0&playsinline=1`}
